...
public interface DialogFactory {
   ...
   * @param title the window title
   * @param content the window content/text
   * @param confirmCallback the window confirm button tex
   * @param confirmButtonText the callback used on Confirm
   * @return a {@link ConfirmDialog} instance
   */
  MessageDialog createMessageDialog(
      @NotNull @Assisted("title") String title,
   ...
   */
  MessageDialog createMessageDialog(
      @NotNull String title, @NotNull IsWidget content, @Nullable ConfirmCallback confirmCallback);
   ...
   * @param title the window title
   * @param content the window content/text
   * @param okButtonLabel overwrite label for OK button
   * @param cancelButtonLabel overwrite label for Cancel button
   * @param confirmCallback the callback used on OK
   * @param cancelCallback the callback used on cancel
   * @return a {@link ConfirmDialog} instance
   */
  ...
  /**
   * Create a confirm dialog with a widget as content and overwrites labels of Ok and Cancel
   * buttons.
   *
   * @param title the window title
   * @param content the window content
   * @param okButtonLabel new label for OK button
   * @param cancelButtonLabel new label for Cancel button
   * @param confirmCallback the callback used on OK
   * @param cancelCallback the callback used on cancel
   * @return a {@link ConfirmDialog} instance
   */
  ...
  /**
   * Create a choice dialog with only text as content. Use empty string for button label to hide
   * button.
   *
   * @param title the window title
   * @param content the window content/text
   * @param firstChoiceLabel the label for the first choice
   * @param secondChoiceLabel the label for the second choice
  ...
  /**
   * Create a choice dialog with a widget as content. Use empty string for button label to hide
   * button.
   *
   * @param title the window title
   * @param content the window content
   * @param firstChoiceLabel the label for the first choice
   * @param secondChoiceLabel the label for the first choice
   * @param firstChoiceCallback the callback used on fist choice
   * @param secondChoiceCallback the callback used on second choice
   * @return a {@link ConfirmDialog} instance
   */
   ...
   * @param firstChoiceLabel the label for the first choice
   * @param secondChoiceLabel the label for the second choice
   * @param thirdChoiceLabel the label for the third choice
   * @param firstChoiceCallback the callback used on fist choice
   * @param secondChoiceCallback the callback used on second choice
   * @param thirdChoiceCallback the callback used on third choice
   * @return a {@link ConfirmDialog} instance
   */
  ChoiceDialog createChoiceDialog(
      @NotNull @Assisted("title") String title,
